class Controler {
    constructor(){
        this.player1 = new Personnage("player01", 90, 145); 
        this.player2 = new Personnage("player02", -120, 1100);
...
//-----------------------------------cote droit------------------------------------------------
    ...
    chrono(player1, player2, view){        //chrono
        ...
        view.reaction1(this.player1, this.player2);
            ...
            // if(player2.sante<= 0){
            //     console.log("mort"); //ici lancer l'alert de fin game over
            //     _this.viewD.mort(_this.player2, _this.player1, _this.viewD);
